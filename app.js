...
(function () {
    ...
    tw.addEventListener('click', function () {
        ...
        setTimeout(() => {
            ...
            b.dataset.action = 'print-x';
        }, 1200);
    });

    document.addEventListener('click', function(e) {
        if (e.target.closest('#btn-xreport') && e.target.closest('#btn-xreport').dataset.action === 'print-x') {
            spawnReceipt('big',
    ...
    function selectP17() {
        ...
        // Set hint text so user knows which MPOS to pick
        const hint = $('#model-hint');
        hint.textContent = 'Серийный номер: ' + state.correctMPOS;
